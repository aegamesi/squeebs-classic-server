...
public class LittleEndianOutputStream extends FilterOutputStream {
     ...
     * @throws IOException if the underlying stream throws an IOException.
     * @see com.macfaq.io.LittleEndianOutputStream#writeByte(int)
     * @see com.macfaq.io.LittleEndianOutputStream#out
     */
     ...
     * @throws IOException if the underlying stream throws an IOException.
     * @see com.macfaq.io.LittleEndianOutputStream#writeChar(int)
     * @see com.macfaq.io.LittleEndianOutputStream#out
     */
     ...
     * @see com.macfaq.io.LittleEndianOutputStream#written
     */
    public int size() {
        return this.written;
    }
